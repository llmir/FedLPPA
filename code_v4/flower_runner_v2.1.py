...
if __name__ == '__main__':
    ...
    assert args.procedure in [
        'flower_pCE_2D', 'flower_pCE_MScaleTreeEnergyLoss_ADD', 'flower_pCE_MScaleTreeEnergyLoss_Recurve', 'flower_pCE_TreeEnergyLoss_2D','flower_pCE_2D_GateCRFTreeEnergyLoss_Ours','flower_pCE_2D_GatedCRFLoss_v2.1','flower_pCE_2D_GatedCRFLoss_Pseudo_v2.1','flower_pCE_2D_GatedCRFLoss_v2.1_auxpCE'
    ]
    ...
    if args.procedure in ['flower_pCE_2D_GatedCRFLoss_v2.1','flower_pCE_2D_GatedCRFLoss_Pseudo_v2.1','flower_pCE_2D_GatedCRFLoss_v2.1_auxpCE']:
