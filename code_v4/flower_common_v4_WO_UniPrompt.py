...
def get_feduniv2_local_keys(model_name, model_state_dict_keys, in_chns, num_classes):
    assert model_name in ['unet_univ2', 'unet_univ3', 'unet_univ4', 'unet_univ5', 'unet_univ5_wo_uniprompt'] 
    p_keywords = []
    if model_name == 'unet_univ2' or model_name == 'unet_univ3' or model_name == 'unet_univ4' or 'unet_univ5' or 'unet_univ5_wo_uniprompt':
        local_keys = ['decoder.out_conv.weight', 'decoder.out_conv.bias']
