...
def get_feduniv2_local_keys(model_name, model_state_dict_keys, in_chns, num_classes):
    assert model_name in ['unet_univ2', 'unet_univ3', 'unet_univ4', 'unet_univ5'] 
    p_keywords = []
    if model_name == 'unet_univ2' or model_name == 'unet_univ3' or model_name == 'unet_univ4' or 'unet_univ5':
        local_keys = ['decoder.out_conv.weight', 'decoder.out_conv.bias']
...
class MyModel(nn.Module):
    ...
    def set_weights(self, weights, config):
        ...
        elif self.args.strategy in ['FedALA', 'FedALALC', 'FedUniV2']:
            eta = 1.0
            num_pre_loss = 10
            threshold = 0.1
...
# # #####
            ...
            if self.args.strategy in ['FedALA', 'FedALALC', 'FedUniV2', 'FedUniV2.1'] and config['iter_global'] <= 150:
                print('skip', config)
                return
