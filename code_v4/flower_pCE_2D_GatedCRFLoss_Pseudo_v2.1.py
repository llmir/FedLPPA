...
# TreeEnergyLoss
                ...
                if self.args.strategy in ['FedUniV2', 'FedUniV2.1']:
                    ...
                    refined_prediction = pseudo_alpha * outputs_soft + (1 - pseudo_alpha) * outputs_soft_auxiliary
                    refined_prediction_soft = torch.softmax(refined_prediction, dim=1) 
                    out_gatedcrf = gatecrf_loss(
                        refined_prediction_soft,
                    ...
                    pseudo_label = refined_prediction.detach()
                    ...
                    loss = torch.add(loss, out_gatedcrf, alpha=0.1)
...
def main():
    ...
    if args.strategy == 'FedRep':
        ...
        assert args.model in ['unet_univ2']
