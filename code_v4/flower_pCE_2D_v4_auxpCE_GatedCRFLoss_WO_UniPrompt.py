...
from flower_common_v4_WO_UniPrompt import (BaseClient, MyModel, fit_metrics_aggregation_fn, TreeEnergyLoss, MScaleRecurveTreeEnergyLoss, evaluate, get_evaluate_fn,
    ...
    def _train(self, config):
        ...
        for i_iter in range(config['iters']):
            ...
            with autocast(enabled=self.amp):
                ...
                elif self.args.model == 'unet_univ5_wo_uniprompt':
                    outputs, feature, de1, de2, de3, de4, prompts, fuse_feature, outputs_auxiliary, distribution_prompts = out
                else:
...
def main():
    ...
    if args.strategy == 'FedRep':
        ...
        assert args.model in ['unet_univ2', 'unet_univ3', 'unet_univ4', 'unet_univ5','unet_univ5_wo_uniprompt']
