...
def train(args, snapshot_path):
    ...
    db_train = BaseDataSets(base_dir=args.root_path, split="train", img_class=args.img_class, transform=transforms.Compose([RandomGenerator(args.patch_size,img_class=args.img_class)
