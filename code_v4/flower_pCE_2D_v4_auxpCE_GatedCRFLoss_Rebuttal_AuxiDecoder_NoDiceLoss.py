...
from flower_common_v4_Rebuttal_AuxiDecoder import (BaseClient, MyModel, fit_metrics_aggregation_fn, TreeEnergyLoss, MScaleRecurveTreeEnergyLoss, evaluate, get_evaluate_fn,
...
# TreeEnergyLoss
                ...
                if self.args.strategy in ['FedUniV2', 'FedUniV2.1']:
                    ...
                    # pseudo_label = outputs_soft_auxiliary.detach()
        ...
        if self.args.strategy in ['FedUniV2', 'FedUniV2.1']:
            ...
            if self.args.img_class == 'odoc' or self.args.img_class == 'polyp':
                outputs_auxiliary = outputs_auxiliary.repeat(3, 1, 1)
