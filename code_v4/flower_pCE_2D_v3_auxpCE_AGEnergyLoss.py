...
from utils.AGEnergyLoss import AGEnergyLoss
...
# TreeEnergyLoss
                unlabeled_RoIs = (sampled_batch['label'] == self.args.num_classes).unsqueeze(1).repeat(1, self.args.num_classes, 1, 1)
                ...
                loss = loss_ce + 0.1 * out_agenergy["loss"]
