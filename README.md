...
The one-click automatic script similar to the [FedICRA](https://github.com/llmir/FedICRA/tree/master?tab=readme-ov-file#4-train-the-model) will be included in subsequent updates.
## 5. Test the model
``` bash
